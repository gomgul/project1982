...
<body>
    ...
    <!-- 메인 ---------------------------------------------------------------->
        <main class="main">
            <div class="main_img">
                <img src="../resources/images/beerking.PNG " width="100%" height="100%" alt="" />
            </div>
            <div >
                <form action="friends.html" method="get" id="login-form">
                	<div name="password" type="text" >업체명 : 비어킹</div>
                	<div name="password" type="text" >장소 : 서울 금천구 가산디지털1로 181 209호</div>
