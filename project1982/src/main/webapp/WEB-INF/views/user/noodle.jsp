...
<body>
    ...
    <!-- 메인 ---------------------------------------------------------------->
        <main class="main">
            <div class="main_img">
                <img src="../resources/images/noodle.PNG " width="100%" height="100%" alt="" />
            </div>
            <div >
                <form action="friends.html" method="get" id="login-form">
                	<div name="password" type="text" >국수나무</div>
                	<div name="password" type="text" >장소 : 서울 금천구 가산디지털1로 131 BYC타워 A동 111호</div>
                	<div name="password" type="text" >02-4545-4545</div>
                    <div name="password" type="text" >2021.12.10</div>
                    <div name="password" type="text" >서빙 및 포장</div>
                  ...
                  <div class="review_star">
                      ...
                      <div class="star">
                          ...
                          <i class="fas fa-star"></i>
                        4.3/5</div>
                      <button id= lotteria>지원하기</button>
                  </div>
            </div>
        </main>
