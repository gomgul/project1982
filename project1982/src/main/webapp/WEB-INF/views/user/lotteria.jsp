...
<body>
    ...
    <!-- 메인 ---------------------------------------------------------------->
        <main class="main">
            <div class="main_img">
                <img src="../resources/images/lotteria.PNG " width="100%" height="100%" alt="" />
            </div>
            <div >
                <form action="friends.html" method="get" id="login-form">
                	<div name="password" type="text" >롯데리아</div>
                	<div name="password" type="text" >서울 금천구 디지털로 188W-MALL 지하 1층</div>
                	<div name="password" type="text" >02-4545-4545</div>
                    <div name="password" type="text" >2021.12.10</div>
                    <div name="password" type="text" >음식 제조 및 포장</div>
