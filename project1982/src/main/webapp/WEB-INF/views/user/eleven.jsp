...
<body>
    ...
    <!-- 메인 ---------------------------------------------------------------->
        <main class="main">
            <div class="main_img">
                <img src="../resources/images/eleven.PNG " width="100%" height="100%" alt="" />
            </div>
            <div >
                <form action="friends.html" method="get" id="login-form">
                	<div name="password" type="text" >업체명 : 세븐일레븐</div>
                	<div name="password" type="text" >장소 : 서울 금천구 가산디지털1로 128</div>
                	<div name="password" type="text" >02-4545-4545</div>
                    <div name="password" type="text" >2021.12.10</div>
                    <div name="password" type="text" >매장 관리 및 진열</div>
